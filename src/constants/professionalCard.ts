...
export const mentions = [
  {
    ...
    category: "mention",
    history:
      "Rafael Sulino foi um dos grandes nomes à frente da Federação Tocantinense de Basquete, sendo responsável por iniciar uma verdadeira transformação na gestão, estrutura e visibilidade da modalidade no estado. Durante seu longo período como presidente, liderou diversos projetos sociais, ampliou o acesso ao basquete e fortaleceu as bases da federação com seriedade, inovação e compromisso com o desenvolvimento esportivo. Sua dedicação e visão o tornaram uma referência para toda a comunidade do basquete tocantinense, deixando um legado que continua inspirando atletas, árbitros, dirigentes e apaixonados pelo esporte.",
  },
];
