        ...
        >
          <div className="flex flex-col xl:flex-row items-start justify-between w-full gap-4 text-white">
            <div className="flex flex-row-reverse items-center justify-center gap-6">
              <h1 className="lg:text-5xl text-xl md:text-3xl">Jaguarz</h1>
            ...
            <div className="flex flex-row flex-wrap items-start md:items-center justify-between gap-4">
              {AVATARS.map((avatar, index) => (
                ...
                >
                  ...
                  <p className="text-xs">Nome da pessoa</p>
                </div>
              ))}
            </div>
          ...
          <div className="flex flex-col lg:flex-row w-full items-start justify-between gap-4 text-white">
            ...
            <div className="w-full lg:w-1/2 flex flex-col items-start justify-center gap-9">
              <p className="w-full text-sm md:text-base lg:text-lg font-normal text-justify">
              ...
              <div className="w-full grid grid-cols-2 lg:grid-cols-3 items-center justify-center gap-12 font-bold">
                <div className="flex flex-col items-center justify-center gap-2 border-2 border-white px-2 py-4 rounded-lg bg-blue-950/90">
                  <p className="text-lg md:text-xl lg:text-2xl">+15</p>
              ...
              <div className="flex flex-row items-center justify-end gap-4 w-full">
                ...
                <button
                  ...
                  className="flex items-center justify-center text-sm md:text-base gap-3 px-6 py-3 bg-yellow-500 text-black rounded-lg hover:bg-yellow-700 hover:scale-105 transition-all duration-300 ease-in-out cursor-pointer font-bold"
                >
                  Próximo time
